...
from lib.state_manager import get_state_manager, track_event, EventType, GenerationRecord
from lib.utils import get_config_value, validate_directory, run_command
...
class PeerConfigGenerator:
    ...
    def generate_peer_config(self, asn: str, peer_info: Dict[str, Any], 
                           vendor: str = "bird", output_file: str = None) -> str:
        """
        ...
        try:
            ...
            logger.info(f"✓ Generated configuration for {asn} ({len(config_content)} chars)")
    ...
    def _prepare_template_vars(self, asn: str, peer_info: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def generate_multiple_peers(self, peer_list: List[Dict[str, Any]], 
                              vendor: str = "bird") -> Dict[str, str]:
        """
    ...
    def generate_from_template_file(self, template_file: str, variables: Dict[str, Any], 
...
Examples:
  ...
  %(prog)s --peer-file peers.json --vendor bird2 --output-dir /tmp/configs
    ...
    # Generation options
    parser.add_argument('--vendor', default='bird', 
                       help='Target vendor (default: bird)')
    ...
    parser.add_argument('--vendor-features', 
                       help='Show features for specific vendor')
    
    # Options
    parser.add_argument('--debug', '-d', action='store_true',
                       help='Enable debug logging')
    parser.add_argument('--validate-only', action='store_true',
                       help='Validate peer information only')
            ...
            if args.validate_only:
                ...
                for i, peer_info in enumerate(peer_list):
                    ...
                    if errors:
                        ...
                        print(f"✓ Peer {i+1} ({peer_info.get('asn', 'unknown')}) is valid")
            else:
